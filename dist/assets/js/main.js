...
},{"../transport":18,"component-inherit":26,"debug":12,"engine.io-parser":27,"parseqs":38,"ws":2,"yeast":39}],24:[function(require,module,exports){
...
var Animation = (function () {
    ...
    _createClass(Animation, [{
        key: 'displayDomElement',
        value: function displayDomElement() {
...
},{"gsap":3}],52:[function(require,module,exports){
'use strict';
...
var Foot = (function () {
  function Foot() {
    ...
    this.socket = (0, _socketIoClient2['default'])(this.host);
  ...
  _createClass(Foot, [{
    ...
    key: 'showGoal',
    value: function showGoal(color, msg) {
      this.color = color;
    ...
    value: function closePopin() {
      ...
      document.querySelector('.cross').addEventListener('click', function () {
        console.log('ok');
        _this.popin.classList.toggle('show');
      });
    }
  }, {
    key: 'listenSockets',
    value: function listenSockets() {
      var _this2 = this;
      ...
      this.socket.on('newConnection', function (data) {
        ...
        _this2.started.addEventListener('click', function () {
          _this2.getId();
          _this2.socket.emit('onNameChange', _this2.player);
          _this2.socket.emit('onStartMatch', 'started');
          _this2.animateItems();
        ...
        _this2.stop.addEventListener('click', function () {
          _this2.stopGame();
          _this2.socket.emit('onStopMatch', 'match stoped');
        });
...
},{"./animation":51,"socket.io-client":4}],53:[function(require,module,exports){
'use strict';
...
(0, _domready2['default'])(function () {
    var foot = new _foot2['default']();
});

},{"./foot":52,"domready":1}]},{},[53]);
